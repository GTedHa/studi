...
## Development environment and release process
 ...
 - create virtualenv with Flask and Studi installed into it (latter is installed in
...
install it (`pip install studi.tar.gz`), ensure that configuration file exists and
`STUDI_SETTINGS` environment variable points to it, ensure that user has access to the
